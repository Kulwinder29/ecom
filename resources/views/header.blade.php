	 ...
	 <header class="header"> {{-- header-v4 --}}
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<a href="{{url('/')}}" class="logo">
						{{-- <img src="images/icons/logo-01.png" alt="IMG-LOGO"> --}}
                        <span style="font-size:1.5rem;font-weight:bolder;">Ecom <span style="color:black;">Store</span></span>
					</a>
						...
						<ul class="main-menu">
							<li>
								...
								<ul class="sub-menu">
									...
									<li><a href="home-02.html">T-shirts</a></li>
							...
							<li>
								...
								<ul class="sub-menu">
									<li><a href="index.html">Clothing</a></li>
									<li><a href="home-02.html">Top Brands</a></li>
									{{-- <li><a href="home-03.html">Homepage 3</a></li> --}}
								</ul>
							</li>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="{{url('/product-detail')}}">Product Detail</a>
				</li>
